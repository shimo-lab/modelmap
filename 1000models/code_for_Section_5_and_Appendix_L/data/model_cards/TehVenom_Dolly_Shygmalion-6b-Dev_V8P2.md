# GPT-J 6B - Dolly_Shygmalion-6b-Dev_V8P2 Mix
## Model description
...
**Warning: Dolly_Shygmalion-6b-Dev_V8P2 may generate NSFW or inappropriate content due to the base models (Mainly [Pygmalion/Pygmalion-6b V8P2](https://huggingface.co/Pygmalion/Pygmalion-6b)) being trained on general user logs, and internet archives.**

### Intended Use:

Research purposes only, intended for responsible use.
Express a conversation in natural language, and Dolly_Shygmalion will pick up on the conversational format.
...
## Information:
For more details, check out the related source models, especially [Pygmalion/Pygmalion-6b V8P2](https://huggingface.co/Pygmalion/Pygmalion-6b) for more information on how to utilize the chat bot formatting expected.
...
Dolly_Shygmalion-6b-Dev_V8P2 combines `Dolly-GPT-J`, `Shinen-6b` and `Pygmalion-6b V8P2`; all three models were blended in a two step process using a simple weighted parameter method
```
(X*A + Y*B)
```
